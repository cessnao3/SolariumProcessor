...
\begin{table}[h!]
	...
	\begin{footnotesize}
		\begin{tabular}{cccc|c|l}
			...
			0 & 0 & 0 & 6 & \texttt{ret} & $\forall_{i \in [15 \rightarrow 0]}$ \texttt{R[i] = mem[--SP]}, \texttt{++PC} \\
			...
			0 & 0 & 0 & R[a] & \texttt{call [a]} & $\forall_{i \in [0 \rightarrow 15]}$ \texttt{mem[SP++] = R[i]}, \texttt{PC = R[a]} \\
