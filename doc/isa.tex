...
On reset, the program counter will be assigned the value contained in the reset vector, which is stored at memory location 0. All of the other registers are reset to their default value of 0. Program execution is then started.
	...
	\begin{footnotesize}
		\begin{tabular}{cccc|c|l}
			...
			0 & 0 & 5 & R[a] & \texttt{call [a]} & $\forall_{i \in [0 \rightarrow 15]}$
 			...
 			0 & 0 & 6 & R[a] & \texttt{int [a]} & Trigger the Software Interrupt within \texttt{R[a]} \\
