...
The current memory mapping structure for the serial input and output device is provided in Table \ref{table:dev-serial-io}. \todo{Create the ability for devices to access full memory map, for things like async writing?}
