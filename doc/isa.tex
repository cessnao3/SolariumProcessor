...
\begin{table}[h!]
	...
	\begin{tabular}{cc|cc|cc|cc}
		...
		08 & \charmapescape{b} Backspace & 28 & \charmap{(} & 48 & \charmap{H} & 68 & \charmap{h} \\
		...
		1B & \charmapescape{e} Escape & 3B & \charmap{;} & 5B & \charmap{[} & 7B & \charmap{\{} \\
		...
		1F & {} & 3F & \charmap{?} & 5F & \charmap{\textunderscore} & 7F & \charmapescape{d} Delete \\
		\hline
	\end{tabular}
