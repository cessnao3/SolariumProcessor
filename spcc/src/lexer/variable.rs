...
fn load_variable_to_register(
    address_load: Vec<String>,
    register: usize,
    variable_name: &str,
) -> Vec<String> {
...
fn save_register_to_variable(
    ...
    assembly.push(format!(
        "; Set Variable {0:} from Register {1:} using {2:}",
        variable_name, register_value, register_loc
    ));
    assembly.extend(address_load);
